...
public class ResponseUtils {
    public <T> ResponseEntity<GenericResponse<T>> generateSuccessResponse(T data) {
    ...
    public <T> ResponseEntity<GenericResponse<T>> generateErrorResponse(GenericException error) {
        GenericResponse<T> response = GenericResponse.<T>builder()
                .success(false)
                .code(error.getCode())
